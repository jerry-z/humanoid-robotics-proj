...
class DDPG(object):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
        ...
        """
        print("input_dims,o:",input_dims['o'],"g:",input_dims['g'],"u:",input_dims['u'])
        print("buffer_size:",buffer_size)
        print("hidden units num:",hidden)
        print("hidden layers num:",layers)
        print("network_class:",network_class)
        print("\n\n\n")
