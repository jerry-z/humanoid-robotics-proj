...
class GraspRelativeSafeEasyEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
    ...
    def reset_model(self):
        ...
        while failed:
            ...
            angle = self.np_random.uniform(-np.pi, np.pi) / 18.0 # easy to grasp pos
            axis = np.array([0., 0., 1.])
...
class GraspCubeRelativeSafeEasyEnv(GraspRelativeSafeEasyEnv):
    def __init__(self):
        GraspRelativeSafeEasyEnv.__init__(self, 'seahand/manipulate_block.xml', 1)
