...
class GraspImageContextEnv(simple_robotics_context.SimpleRoboticsEnv, utils.EzPickle):
    ...
    def getcontext(self):
        size = 500
        img = self.sim.render(camera_name='external_camera_0',width=size,height=size)
        assert img.shape == (size,size,3)
        context = img / 255.0
        context = context[::4,::4,:] #subsample
        return context
...
class GraspCubeImageContextEnv(GraspImageContextEnv):
    def __init__(self):
        GraspImageContextEnv.__init__(self, 'seahand/manipulate_block.xml', 1)


class GraspEggActContextEnv(GraspImageContextEnv):
    def __init__(self):
        GraspImageContextEnv.__init__(self, 'seahand/manipulate_egg.xml', 1)


class GraspPenActContextEnv(GraspImageContextEnv):
    def __init__(self):
        GraspImageContextEnv.__init__(self, 'seahand/manipulate_pen.xml', 1)


class GraspBallActContextEnv(GraspImageContextEnv):
    def __init__(self):
        GraspImageContextEnv.__init__(self, 'seahand/manipulate_ball.xml', 1)


class GraspCylinderActContextEnv(GraspImageContextEnv):
    def __init__(self):
        GraspImageContextEnv.__init__(self, 'seahand/manipulate_cylinder.xml', 1)
