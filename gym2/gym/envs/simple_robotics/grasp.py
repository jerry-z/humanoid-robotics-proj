...
class GraspEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
...
class GraspCubeEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_block.xml', 1)

class ROAM_GraspCubeEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_block.xml', 1)

class GraspEggEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_egg.xml', 1)


class GraspPenEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_pen.xml', 1)


class GraspBallEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_ball.xml', 1)


class GraspCylinderEnv(GraspEnv):
    def __init__(self):
        GraspEnv.__init__(self, 'seahand/manipulate_cylinder.xml', 1)
