...
class GraspRelativeEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
    ...
    def reset_model(self):
        ...
        while failed:
            ...
            self.sim.model.geom_size[-2, :] = np.random.randn(3) * (HIGH - LOW) + HIGH
...
class GraspCubeRelativeEnv(GraspRelativeEnv):
    def __init__(self):
        GraspRelativeEnv.__init__(self, 'seahand/manipulate_block.xml', 1)


class GraspEggRelativeEnv(GraspRelativeEnv):
    def __init__(self):
        GraspRelativeEnv.__init__(self, 'seahand/manipulate_egg.xml', 1)


class GraspPenRelativeEnv(GraspRelativeEnv):
    def __init__(self):
        GraspRelativeEnv.__init__(self, 'seahand/manipulate_pen.xml', 1)


class GraspBallRelativeEnv(GraspRelativeEnv):
    def __init__(self):
        GraspRelativeEnv.__init__(self, 'seahand/manipulate_ball.xml', 1)


class GraspCylinderRelativeEnv(GraspRelativeEnv):
    def __init__(self):
        GraspRelativeEnv.__init__(self, 'seahand/manipulate_cylinder.xml', 1)
