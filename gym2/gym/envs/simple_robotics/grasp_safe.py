...
class GraspRelativeSafeEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
...
class GraspCubeRelativeSafeEnv(GraspRelativeSafeEnv):
    def __init__(self):
        GraspRelativeSafeEnv.__init__(self, 'seahand/manipulate_block.xml', 1)


class GraspEggRelativeSafeEnv(GraspRelativeSafeEnv):
    def __init__(self):
        GraspRelativeSafeEnv.__init__(self, 'seahand/manipulate_egg.xml', 1)


class GraspPenRelativeSafeEnv(GraspRelativeSafeEnv):
    def __init__(self):
        GraspRelativeSafeEnv.__init__(self, 'seahand/manipulate_pen.xml', 1)


class GraspBallRelativeSafeEnv(GraspRelativeSafeEnv):
    def __init__(self):
        GraspRelativeSafeEnv.__init__(self, 'seahand/manipulate_ball.xml', 1)


class GraspCylinderRelativeSafeEnv(GraspRelativeSafeEnv):
    def __init__(self):
        GraspRelativeSafeEnv.__init__(self, 'seahand/manipulate_cylinder.xml', 1)
