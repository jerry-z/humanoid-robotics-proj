...
class GraspRelativeSafeSmallObjectEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
    ...
    def reset_model(self):
        ...
        print(self.sim.model.geom_size[-2:, :])
...
class GraspCubeRelativeSafeSmallObjectEnv(GraspRelativeSafeSmallObjectEnv):
    def __init__(self):
        GraspRelativeSafeSmallObjectEnv.__init__(self, 'seahand/manipulate_block.xml', 1)
