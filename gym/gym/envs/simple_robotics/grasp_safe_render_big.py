...
class GraspRelativeSafeRenderBigEnv(simple_robotics_env.SimpleRoboticsEnv, utils.EzPickle):
...
class GraspCubeRelativeSafeRenderBigEnv(GraspRelativeSafeRenderBigEnv):
    def __init__(self):
        GraspRelativeSafeRenderBigEnv.__init__(self, 'seahand/manipulate_block.xml', 1)
