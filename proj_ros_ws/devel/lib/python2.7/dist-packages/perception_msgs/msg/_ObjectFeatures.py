...
"""autogenerated by genpy from perception_msgs/ObjectFeatures.msg. Do not edit."""
import sys
...
class ObjectFeatures(genpy.Message):
  _md5sum = "fe6a1b3ba02e62219365f96560d5f759"
  _type = "perception_msgs/ObjectFeatures"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string object_name
string[] names
float64[] values
"""
  __slots__ = ['object_name','names','values']
