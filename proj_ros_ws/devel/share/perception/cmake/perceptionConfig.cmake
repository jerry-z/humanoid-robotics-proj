...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/jzhang102/Documents/humanoid_proj/proj_ros_ws/src/cse481wi18/perception)
  set(perception_DEVEL_PREFIX /home/jzhang102/Documents/humanoid_proj/proj_ros_ws/devel)
  ...
  set(perception_INSTALL_PREFIX /home/jzhang102/Documents/humanoid_proj/proj_ros_ws/install)
...
if(NOT "/home/jzhang102/Documents/humanoid_proj/proj_ros_ws/src/cse481wi18/perception/include " STREQUAL " ")
  set(perception_INCLUDE_DIRS "")
  set(_include_dirs "/home/jzhang102/Documents/humanoid_proj/proj_ros_ws/src/cse481wi18/perception/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jzhang102/Documents/humanoid_proj/proj_ros_ws/src/cse481wi18/perception/${idir}'.  ${_report}")
    endif()
    _list_append_unique(perception_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "perception_box_fitter;perception_crop;perception_downsample;perception_feature_extraction;perception_object_recognizer;perception_segmentation")
...
set(depends "geometry_msgs;pcl_ros;rosbag;roscpp;rospy;sensor_msgs;shape_msgs;simple_grasping;tf")
